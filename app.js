...
function startTimer(idString) {
    ...
    if (currentRunningClock == clockId) {
        alert("Clock is already running. Please click reset if you want to start again or click on Restart if you want to Restart from previous counter");
    }
    ...
    if (currentRunningClock != clockId && currentRunningClock != -1) {
        alert("Please stop the running clock to start this");
    }
